...
type LogInError =
    ...
    | PasswordNeedMigration

// лучше описать сущность, из которой можно получить jwt
type JwtBearer = string

type LogInUser = LogInUserCommand -> TaskResult<JwtBearer, LogInError>
